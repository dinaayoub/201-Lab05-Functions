...
the second element is the product of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and 
...
You're going to have to be resourceful to figure out how to do this. This function should handle an array containing three elements. However, 
...
function multiplyArray(multArr) { //eslint-disable-line
  var multiplicationOfArrayNumbers = 1;
  var stringOfNumbers = 'The numbers ';
  for (var i=0; i<multArr.length;i++) {
    multiplicationOfArrayNumbers = multiply(multiplicationOfArrayNumbers,multArr[i])[0];
    if (i!== multArr.length - 1) {
      stringOfNumbers += multArr[i] + ',';
    } else {
      stringOfNumbers += multArr[i];
    }
  }
  stringOfNumbers += ' have a product of ' + multiplicationOfArrayNumbers + '.';
  return [multiplicationOfArrayNumbers,stringOfNumbers];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  //I'd already done this in multiply array so.. just calling that. 
